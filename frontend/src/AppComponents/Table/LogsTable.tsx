...
const SEVERITY_RANGES = [
  { range: [0, 2], label: "Informational", severity: "0-2", icon: Info, variant: "default" as const },
  { range: [3, 5], label: "Warning", severity: "3-5", icon: TriangleAlert, variant: "warning" as const },
  { range: [6, 7], label: "Debug", severity: "6-7", icon: Bug, variant: "critical" as const },
  { range: [8, 10], label: "Alert", severity: "8-10", icon: AlertCircle, variant: "destructive" as const },
];
...
const getSeverityConfig = (severity: number | null) => {
  if (severity === null) {
    return { label: 'N/A', severity: '', variant: 'outline' as const, icon: Info };
  }
  ...
  return config || { label: 'Unknown', severity: '', variant: 'outline' as const, icon: Info };
};
